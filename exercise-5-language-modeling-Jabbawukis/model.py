...
class LanguageModel(torch.nn.Module):  # inherits from nn.Module
    ...
    def __init__(
        ...
        self.loss = torch.nn.NLLLoss(ignore_index=self.pad_index)
    ...
    def forward(
        ...
        packed_input = torch.nn.utils.rnn.pack_padded_sequence(embeddings, input_lengths, batch_first=True,
    ...
    def generate_text(
        ...
        # adjusted according to https://moodle.hu-berlin.de/mod/forum/discuss.php?d=1008359&parent=1741863
